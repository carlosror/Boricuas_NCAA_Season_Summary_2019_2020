...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  defineColor("Firebrick", 24, 236, 218, 54)
  
  insert_image(-0.5, 0, 616, 796, "NCAA_DIII_cover.jpg")
  div_width = 190
  div_rect = createRect(612 - div_width, 0, div_width, 30)
  setFillColor("Firebrick", div_rect); setLineColor("Firebrick", div_rect)
  text_frame(612 - div_width + 4, 5, div_width, 35, ["NCAA Division III"], ["Asimov Print C"], [24], ["White"], alignment = ALIGN_RIGHT)
  insert_image(30, 56, 70, 70 * (1179.0 / 1200), "./Division_logos/NCAA_DIII_logo_original.png")
  text_frame(10, 685, 170, 70, ["Alejandra Figueroa", "Manhattanville College", "New York", "Photo: Mike McLaughlin"], ["Asimov Print C" for idx in range(4)], 4 * [12], 
             ["White" for idx in range(4)], alignment = ALIGN_LEFT, line_spacing = 15)