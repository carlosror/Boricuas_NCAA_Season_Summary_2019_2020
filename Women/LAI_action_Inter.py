...
players_list = []
players_names_list = []
with open("LAI_action_Inter.csv") as f:
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    setText("Universidad Interamericana", page_header)
    setTextColor("Inter2", page_header)
    ...
    setTextColor("Inter2", years1); setTextColor("Inter2", years2)
