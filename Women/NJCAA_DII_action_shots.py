...
players_list = []
players_names_list = []
with open("NJCAA_DII_action.csv") as f:
  ...
  for line in f:
    ...
    if (full_name[1] == "de" or full_name[1] == "La"):
      ...
      if (player_name in players_names_list): 
        ...
        image_filename = "./NJCAA_DII_action/" + first_name + "_" + full_name[1] + "_" + full_name[2] + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./NJCAA_DII_action/" + first_name + "_" + full_name[1] + "_" + full_name[2] + ".jpg"
    else:
      player_name = first_name + " " + first_last_name
      if (player_name in players_names_list): 
        player_name_count = sum([1 for plyr in players_names_list if plyr == player_name])
        image_filename = "./NJCAA_DII_action/" + first_name + "_" + first_last_name + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./NJCAA_DII_action/" + first_name + "_" + first_last_name + ".jpg"
      
    besosa_porrata = "Fabianne Besosa & Jexley Porrata"
    if (current_line_list[0] == besosa_porrata):
      player_name = besosa_porrata
      image_filename = "./NJCAA_DII_action/" + besosa_porrata.replace(" ", "_") + ".jpg"
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    setText("NJCAA Division II Action", page_header)
    ...
    for row in range(4):
      for col in range(2):
        ...
        if (current_player[0] == besosa_porrata):
