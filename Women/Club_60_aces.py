...
players_list = []
players_names_list = []
with open("club_60_aces.csv") as f:
  ...
  for line in f:
    ...
    if (full_name[1] == "de" or full_name[1] == "La"):
      ...
      if (player_name in players_names_list): 
        ...
        image_filename = "./" + "Club_60_aces/"  + first_name + "_" + full_name[1] + "_" + full_name[2] + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_60_aces/" + first_name + "_" + full_name[1] + "_" + full_name[2] + ".jpg"
    else:
      player_name = first_name + " " + first_last_name
      if (player_name in players_names_list): 
        player_name_count = sum([1 for plyr in players_names_list if plyr == player_name])
        image_filename = "./" + "Club_60_aces/" + first_name + "_" + first_last_name + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_60_aces/" + first_name + "_" + first_last_name + ".jpg"
    ...
    player_stat_1 = current_line_list[15]
    
    single_player_list = [player_name, image_filename, player_school, school_state, player_conf, school_division, player_stat_1]
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    page_title = "Service that is aces\n"
    page_subtitle = "Players with 60+ service aces"
    ...
    for row in range(2):
      for col in range(3):
        ...
        if (page == 1 and col == 1 and row == 1):
          ...
          insertText("Matches with 5+ aces", -1, table_title)
          ...
          num_lines = len(open("./Club_60_aces_5plus_aces_matches_2019_2020.csv").readlines()) - 1
          
          with open("./Club_60_aces_5plus_aces_matches_2019_2020.csv") as f:
            next(f) # skip headers row
            line_counter = 0
            line_height = 17
          ...
          player_frame_1 = createText(banner_x + 174 + 15, photo_y + 24 + 4, 130, 200)
          stat_frame_1 = createText(banner_x + 174 + 15 + 130, photo_y + 24 + 4, 30, 200)
