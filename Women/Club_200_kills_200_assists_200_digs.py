...
players_list = []
players_names_list = []
with open("club_200_kills_200_assists_200_digs_photo.csv") as f:
  ...
  for line in f:
    ...
    single_player_list = [player_name, image_filename, player_school, school_state, player_conf, school_division, player_stat_1, player_stat_2, player_stat_3, player_photo]
  ...
  for page in range(num_pages):
    ...
    for row in range(1):
      for col in range(2):
        ...
        photo_credit = "Photo: " + current_player[9].replace("\n", "")
        photo_credit_length = len(photo_credit)
        photo_credit_width = 3.0 * photo_credit_length + 2.5
        photo_credit_banner = createRect(photo_x, photo_y + 382 - 8, photo_credit_width, 8)
        ...
        photo_credit_text = createText(photo_x, photo_y + 382 - 8 + 1.5, photo_credit_width, 10)
