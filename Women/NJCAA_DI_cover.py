...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  insert_image(-0.5, 0, 616, 796, "NJCAA_DI_cover.jpg")
  div_width = 190
  div_rect = createRect(612 - div_width, 0, div_width, 30)
  setFillColor("NJCAA Blue", div_rect); setLineColor("NJCAA Blue", div_rect)
  text_frame(612 - div_width + 4, 5, div_width, 35, ["NJCAA Division I"], ["Asimov Print C"], [24], ["White"], alignment = ALIGN_RIGHT)
  insert_image(30, 56, 70, 70 * (307.0 / 344), "./Division_logos/NJCAA_DI_logo.png")
  text_frame(10, 685, 170, 70, ["María Hernández", "Santa Fe College", "Florida", "Photo: Tom Hagerty"], ["Asimov Print C" for idx in range(4)], 4 * [12], 
