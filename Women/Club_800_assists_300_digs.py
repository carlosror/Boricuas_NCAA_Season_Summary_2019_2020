  ...
  for line in f:
    ...
    if (full_name[1] == "de" or full_name[1] == "La"):
      ...
      if (player_name in players_names_list): 
        ...
        image_filename = "./" + "Club_800_assists_300_digs/"  + first_name + "_" + full_name[1] + "_" + full_name[2] + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_800_assists_300_digs/" + first_name + "_" + full_name[1] + "_" + full_name[2] + ".jpg"
    else:
      player_name = first_name + " " + first_last_name
      if (player_name in players_names_list): 
        player_name_count = sum([1 for plyr in players_names_list if plyr == player_name])
        image_filename = "./" + "Club_800_assists_300_digs/" + first_name + "_" + first_last_name + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_800_assists_300_digs/" + first_name + "_" + first_last_name + ".jpg"
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    page_title = "Defensive-minded setters\n"
    page_subtitle = "Players with 800+ assists and 300+ digs"
    ...
    for row in range(2):
      for col in range(3):
        ...
        stat_banner_width = 44
        stat_banner_height = 24
        ellipse_width = 22
        ellipse_height = 24
        stat_banner_ellipse = createEllipse((banner_x + 126 - ellipse_width / 2), (photo_y + 13), ellipse_width, ellipse_height)
        setFillColor("White", stat_banner_ellipse); setLineColor("None", stat_banner_ellipse)
        
        stat_banner = createRect(banner_x + 126, photo_y + 13, stat_banner_width, stat_banner_height)
        setFillColor("White", stat_banner); setLineColor("None", stat_banner)
        stat_text = createText(banner_x + 126 - 3, photo_y + 16, stat_banner_width, stat_banner_height)
        ...
        if (page == 0 and col == 1 and row == 1):
          ...
          insertText("Matches with 40+ assists and 15+ digs", -1, table_title)
          ...
          num_lines = len(open("./Club_800_assists_300_digs_40plus_assists_and_15plus_digs_matches_2019_2020.csv").readlines()) - 1
          
          with open("./Club_800_assists_300_digs_40plus_assists_and_15plus_digs_matches_2019_2020.csv") as f:
            next(f) # skip headers row
            line_counter = 0
            line_height = 17
