...
with open("NCAA_NJCAA_NAIA_beach_volleyball_players_2019_2020.csv") as f:
  ...
  for line in f:
    ...
    cl_ht = current_line_list[1] + " | " + current_line_list[3]
    ...
    single_player_list = [player_name, hometown, cl_ht, major, player_school, school_state]
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    setText("Beach Volleyball Players", page_header)
    ...
    insertText("Yr | Ht", -1, player_class_frame_header)
