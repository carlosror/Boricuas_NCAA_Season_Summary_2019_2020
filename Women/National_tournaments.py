...
with open("National_tournaments.csv") as f:
  ...
  for line in f:
    ...
    photo_credit = current_line_list[6]
    
    single_player_list = [player_name, image_filename, player_school, school_state, school_division, tournament, outcome, photo_credit]
