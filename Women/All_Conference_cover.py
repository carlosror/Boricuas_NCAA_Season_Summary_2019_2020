...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  defineColor("Coppin", 233, 180, 53, 122)
  
  insert_image(-0.5, 0, 616, 796, "Awards_cover.jpg")
  div_width = 170
  div_rect = createRect(612 - div_width, 0, div_width, 30)
  setFillColor("White", div_rect); setLineColor("None", div_rect)
  text_frame(612 - div_width + 4, 5, div_width, 35, ["All-Conference"], ["Asimov Print C"], [24], ["Coppin"], alignment = ALIGN_RIGHT)
  # insert_image(30, 56, 70, 70 * (1179.0 / 1200), "./Division_logos/NCAA_DI_logo_original.png")
  text_frame(68, 109, 225, 70, ["Ashley Román", "Coppin State University", "Maryland", "Photo: Coppin State University Athletics"], ["Asimov Print C" for idx in range(4)], 4*[12], 
