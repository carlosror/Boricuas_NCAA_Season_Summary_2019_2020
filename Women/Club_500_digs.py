...
players_list = []
players_names_list = []
with open("club_500_digs_photo.csv") as f:
  ...
  for line in f:
    ...
    if (full_name[1] == "de" or full_name[1] == "La"):
      ...
      if (player_name in players_names_list): 
        ...
        image_filename = "./" + "Club_500_digs/"  + first_name + "_" + full_name[1] + "_" + full_name[2] + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_500_digs/" + first_name + "_" + full_name[1] + "_" + full_name[2] + ".jpg"
    else:
      player_name = first_name + " " + first_last_name
      if (player_name in players_names_list): 
        player_name_count = sum([1 for plyr in players_names_list if plyr == player_name])
        image_filename = "./" + "Club_500_digs/" + first_name + "_" + first_last_name + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_500_digs/" + first_name + "_" + first_last_name + ".jpg"
    ...
    player_digs = current_line_list[17]
    player_photo = current_line_list[24]
    
    single_player_list = [player_name, image_filename, player_school, school_state, player_conf, school_division, player_digs, player_photo]
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    page_title = "The Digging Brigade\n"
    ...
    for row in range(3):
      for col in range(3):
        ...
        photo_y = 72 + 23.5 + row * (198 + 23.5)
        player_photo = createImage(photo_x, photo_y, 174, 140)
        ...
        photo_credit_banner = createRect(photo_x + 174.0 - photo_credit_width, photo_y + 140 - 8, photo_credit_width, 8)
        ...
        photo_credit_text = createText(photo_x + 174.0 - photo_credit_width, photo_y + 140 - 8 + 1.5, photo_credit_width, 10)
        ...
        banner_x = photo_x
        banner_y = photo_y + 140
        player_banner_height = 30
        player_banner = createRect(banner_x, banner_y, 174, player_banner_height)
        ...
        stat_banner_ellipse = createEllipse(banner_x + 137, (photo_y + stat_banner_height - ellipse_height / 2), ellipse_width, ellipse_height)
        setFillColor("White", stat_banner_ellipse); setLineColor("None", stat_banner_ellipse)
        
        stat_banner = createRect(banner_x + 137, photo_y, stat_banner_width, stat_banner_height)
        setFillColor("White", stat_banner); setLineColor("None", stat_banner)
        stat_text = createText(banner_x + 137, photo_y + 6, stat_banner_width, stat_banner_height)
        ...
        player_name = createText(banner_x + 33 + 5 + 1, player_name_ypos - 1, 136, 30)
        ...
        player_conf_background = createRect(banner_x + 0.5, banner_y + player_banner_height, 174, player_conf_background_height)
        ...
        player_conf_frame = createText(banner_x + 33 + 5 + 1, banner_y + player_banner_height + offset, 136, 23)
        ...
        if (page == 2 and col == 0 and row == 1):
          player_table_header_height = 20.0
          player_table_header = createRect(banner_x + 174 + 9, photo_y, 2 * 174 + 9, 24)
          setFillColor("NJCAA Blue", player_table_header); setLineColor("NJCAA Blue", player_table_header)
          
          table_title = createText(banner_x + 174 + 9, photo_y + 4.5, 2 * 174 + 9, 20)
          insertText("Number of matches with 30+ digs", -1, table_title)
          ...
          num_lines = len(open("./Club_500_digs_30plus_digs_matches_2019_2020.csv").readlines()) - 1
          
          with open("./Club_500_digs_30plus_digs_matches_2019_2020.csv") as f:
            next(f) # skip headers row
            line_counter = 0
            line_height = 17
            for idx in range(num_lines / 2):
              line_ypos = photo_y + 24 + line_counter * line_height
              line_background = createRect(banner_x + 174 + 9, line_ypos, 2 * 174 + 9, line_height)
          ...
          player_frame_1 = createText(banner_x + 174 + 15, photo_y + 24 + 3, 130, 180)
          stat_frame_1 = createText(banner_x + 174 + 15 + 130, photo_y + 24 + 3, 50, 180)
          player_frame_2 = createText(banner_x + 174 + 15 + 130 + 50, photo_y + 24 + 3, 130, 180)
          stat_frame_2 = createText(banner_x + 174 + 15 + 130 + 50 + 130, photo_y + 24 + 3, 50, 180)
          ...
          with open("./Club_500_digs_30plus_digs_matches_2019_2020.csv") as f:
            ...
            for line in f:
              ...
              if line_counter < 10:
                ...
                insertText(current_line_list[0] + "\n", -1, player_frame_2)
                insertText(current_line_list[1], -1, stat_frame_2)
              line_counter += 1
          ...
          setTextAlignment(ALIGN_CENTERED, stat_frame_1)
          
          setFont("Asimov Print C", player_frame_2); setFontSize(11, player_frame_2)
          setTextColor("NJCAA Blue", player_frame_2); setLineSpacing(17.05, player_frame_2)
          setTextAlignment(ALIGN_LEFT, player_frame_2)
          
          setFont("Asimov Print C", stat_frame_2); setFontSize(11, stat_frame_2)
          setTextColor("NJCAA Blue", stat_frame_2); setLineSpacing(17.05, stat_frame_2)
          setTextAlignment(ALIGN_CENTERED, stat_frame_2)
