...
players_list = []
players_names_list = []
with open("club_300_kills_300_digs_photo.csv") as f:
  ...
  for line in f:
    ...
    if (full_name[1] == "de" or full_name[1] == "La"):
      ...
      if (player_name in players_names_list): 
        ...
        image_filename = "./" + "Club_300_kills_300_digs/"  + first_name + "_" + full_name[1] + "_" + full_name[2] + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_300_kills_300_digs/" + first_name + "_" + full_name[1] + "_" + full_name[2] + ".jpg"
    else:
      player_name = first_name + " " + first_last_name
      if (player_name in players_names_list): 
        player_name_count = sum([1 for plyr in players_names_list if plyr == player_name])
        image_filename = "./" + "Club_300_kills_300_digs/" + first_name + "_" + first_last_name + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_300_kills_300_digs/" + first_name + "_" + first_last_name + ".jpg"
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    page_title = "Killing It & Digging It\n"
    page_subtitle = "Players with 300+ kills and 300+ digs"
    ...
    for row in range(2):
      for col in range(3):
        ...
        ellipse_width = 22
        ellipse_height = 24
        stat_banner_ellipse = createEllipse((banner_x + 137 - ellipse_width / 2), (photo_y + 13), ellipse_width, ellipse_height)
        setFillColor("White", stat_banner_ellipse); setLineColor("None", stat_banner_ellipse)
        
        stat_banner = createRect(banner_x + 137, photo_y + 13, stat_banner_width, stat_banner_height)
        setFillColor("White", stat_banner); setLineColor("None", stat_banner)
        stat_text = createText(banner_x + 137 - 3, photo_y + 16, stat_banner_width, stat_banner_height)
        ...
        stat_banner2_width = 33
        stat_banner2_height = 24
        ellipse2_width = 22
        ellipse2_height = 24
        stat_banner_ellipse2 = createEllipse((banner_x + 137 - ellipse2_width / 2), (photo_y + 250 - stat_banner2_height - 13), ellipse2_width, ellipse2_height)
        setFillColor("White", stat_banner_ellipse2); setLineColor("None", stat_banner_ellipse2)
        
        stat_banner2 = createRect(banner_x + 137, (photo_y + 250 - stat_banner2_height - 13), stat_banner2_width, stat_banner2_height)
        setFillColor("White", stat_banner2); setLineColor("None", stat_banner2)
        stat_text2 = createText(banner_x + 137 - 3, (photo_y + 250 - stat_banner2_height - 13 + 3), stat_banner2_width, stat_banner2_height)
        ...
        if (page == 1 and col == 1 and row == 1):
          player_table_header = createRect(banner_x + 170 + 15, photo_y, 170, 48)
          setFillColor("NJCAA Blue", player_table_header); setLineColor("NJCAA Blue", player_table_header)
          
          table_title = createText(banner_x + 170 + 15, photo_y + 6.5, 170, 48)
          insertText("Matches with 15+ kills and 15+ digs", -1, table_title)
          setTextColor("White", table_title)
          setFont("Playball Regular", table_title); setFontSize(17, table_title); 
          setTextAlignment(ALIGN_CENTERED, table_title); setLineSpacing(20, table_title)
          
          num_lines = len(open("./Club_300_kills_300_digs_15plus_kills_and_digs_matches_2019_2020.csv").readlines()) - 1
          
          with open("./Club_300_kills_300_digs_15plus_kills_and_digs_matches_2019_2020.csv") as f:
            next(f) # skip headers row
            line_counter = 0
            line_height = 17
            for idx in range(num_lines):
              line_ypos = photo_y + 48 + line_counter * line_height
          ...
          player_frame_1 = createText(banner_x + 174 + 15, photo_y + 48 + 4, 130, 200)
          stat_frame_1 = createText(banner_x + 174 + 15 + 130, photo_y + 48 + 4, 30, 200)
