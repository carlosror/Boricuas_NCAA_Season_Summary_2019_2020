...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  insert_image(-0.5, 0, 616, 796, "Beach_VB_cover.jpg")
  div_width = 185
  div_rect = createRect(612 - div_width, 0, div_width, 30)
  setFillColor("Cyan", div_rect); setLineColor("Cyan", div_rect)
  text_frame(612 - div_width + 4, 5, div_width, 35, ["Beach Volleyball"], ["Asimov Print C"], [24], ["White"], alignment = ALIGN_RIGHT)
  # insert_image(30, 56, 70, 70 * (1179.0 / 1200), "./Division_logos/NCAA_DII_logo_original.png")
  text_frame(10, 705, 170, 70, ["Eva Torruella", "Tulane University", "Louisiana", "Photo: Parker Waters"], ["Asimov Print C" for idx in range(4)], 4 * [12], 
