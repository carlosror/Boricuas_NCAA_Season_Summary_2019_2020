...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  defineColor("NCAT", 182, 125, 8, 13)
  
  insert_image(-0.5, 0, 616, 796, "Outstanding_matches_cover.jpg")
  div_width = 235
  div_rect = createRect(612 - div_width, 0, div_width, 30)
  setFillColor("White", div_rect); setLineColor("None", div_rect)
  text_frame(612 - div_width + 4, 5, div_width, 35, ["Outstanding Matches"], ["Asimov Print C"], [24], ["NCAT"], alignment = ALIGN_RIGHT)
  # insert_image(30, 56, 70, 70 * (1179.0 / 1200), "./Division_logos/NCAA_DI_logo_original.png")
  text_frame(10, 50, 200, 50, ["Andrea Laboy Rivera", "North Carolina A&T State University", "Photo: Kevin Dorsey"], ["Asimov Print C" for idx in range(3)], [12, 12, 12], 
             ["White" for idx in range(3)], alignment = ALIGN_LEFT, line_spacing = 15)