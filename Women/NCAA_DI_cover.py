...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  insert_image(-0.5, 0, 616, 796, "NCAA_DI_cover.jpg")
  div_width = 180
  div_rect = createRect(612 - div_width, 0, div_width, 30)
  setFillColor("White", div_rect); setLineColor("None", div_rect)
  text_frame(612 - div_width + 4, 5, div_width, 35, ["NCAA Division I"], ["Asimov Print C"], [24], ["Black"], alignment = ALIGN_RIGHT)
  insert_image(30, 56, 70, 70 * (1179.0 / 1200), "./Division_logos/NCAA_DI_logo_original.png")
  text_frame(440, 650, 168, 70, ["Dariana Hollingsworth Santana", "University of Missouri", "Photo: Missouri Athletics"], ["Asimov Print C" for idx in range(3)], [12, 12, 12], 
