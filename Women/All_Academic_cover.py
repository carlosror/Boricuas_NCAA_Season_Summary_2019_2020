...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  defineColor("Quinnipiac", 181, 101, 4, 7)
  
  insert_image(-0.5, 0, 616, 796, "All_Academic_cover.jpg")
  div_width = 220
  div_rect = createRect(612 - div_width, 0, div_width, 30)
  setFillColor("White", div_rect); setLineColor("None", div_rect)
  text_frame(612 - div_width + 4, 5, div_width, 35, ["Academic  All-Stars"], ["Asimov Print C"], [24], ["Quinnipiac"], alignment = ALIGN_RIGHT)
  # insert_image(30, 56, 70, 70 * (1179.0 / 1200), "./Division_logos/NCAA_DI_logo_original.png")
  text_frame(10, 700, 200, 70, ["Alejandra Rodríguez", "Quinnipiac University", "Connecticut", "Photo: John Hassett"], ["Asimov Print C" for idx in range(4)], 4 * [12], 
