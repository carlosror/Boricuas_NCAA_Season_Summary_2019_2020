...
players_list = []
players_names_list = []
with open("LAI_Action_USC.csv") as f:
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    setText("Universidad del Sagrado Corazón", page_header)
    setTextColor("USC2", page_header)
    ...
    setTextColor("USC2", years1); setTextColor("USC2", years2)
