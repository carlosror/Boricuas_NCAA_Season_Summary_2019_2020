...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  text_frame(612 - div_width + 4, 5, div_width, 35, ["Awards"], ["Asimov Print C"], [24], ["Coppin"], alignment = ALIGN_RIGHT)
  # insert_image(30, 56, 70, 70 * (1179.0 / 1200), "./Division_logos/NCAA_DI_logo_original.png")
  text_frame(380, 650, 225, 70, ["Ashley Román", "Coppin State University", "Maryland", "Photo: Coppin State University Athletics"], ["Asimov Print C" for idx in range(4)], 4*[12], 
