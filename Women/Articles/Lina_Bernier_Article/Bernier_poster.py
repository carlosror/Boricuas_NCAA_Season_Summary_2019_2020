...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  insert_image(36, 30, 100.85, 100, "./../../School_Logos/Florida_International_University.png")
  
  text_frame(15, 31, 588, 124, ["LINA BERNIER", "Standing out on the court, on ", "the sand, and in the classroom"], 
             ["Pink Sans 130" for idx in range(3)], [60, 24, 24], colors = ["White" for idx in range(3)], line_spacing = 26)
  
  insert_image(15, 153, 294, 622, "Bernier_poster_scaled.jpg")
  
  text_1_height = 80; text_1_ypos = 161.5; spacing = 34
  text_frame(341, text_1_ypos, 270, text_1_height, ["1,376", "career digs*"], ["Pink Sans 130", "Arial Regular"], 
  ...
  draw_line(341, line_2_ypos, 341 + 30, line_2_ypos, line_type = LINE_SOLID, color = "Black", width = 2)
  
  text_3_ypos = text_2_ypos + text_1_height + spacing
  text_frame(341, text_3_ypos, 270, text_1_height, ["1x", "Top Flight Award***"], ["Pink Sans 130", "Arial Regular"], 
             [60, 25], colors = ["NJCAA Blue", "Black"], line_spacing = 30, alignment = ALIGN_LEFT)
  ...
  draw_line(341, line_4_ypos, 341 + 30, line_4_ypos, line_type = LINE_SOLID, color = "Black", width = 2)
