...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  defineColor("FIU Blue", 240, 202, 10, 101)
  ...
  setFillColor("FIU Blue", top_rect); setLineColor("NJCAA Blue", top_rect)
  ...
  setFillColor("FIU Blue", photo_credit_banner); setLineColor("None", photo_credit_banner); setFillTransparency(0.70, photo_credit_banner)
  ...
  text_frame(330, text_1_ypos, 270, text_1_height, ["1,376", "career digs*"], ["Pink Sans 130", "Arial Regular"], 
             [60, 20], colors = ["FIU Blue", "Black"], line_spacing = 30, alignment = ALIGN_LEFT)
