...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  defineColor("RURP", 1, 245, 216, 2)
  top_rect = createRect(0, 0, 612, 36)
  setFillColor("RURP", top_rect); setLineColor("RURP", top_rect)
  bottom_rect = createRect(0, 756, 612, 36)
  setFillColor("RURP", bottom_rect); setLineColor("RURP", bottom_rect)
  text_frame(0, 5, 612, 36, ["Recinto Universitario de Río Piedras"], ["OLD SPORT 02 ATHLETIC NCV Regular"], [24], colors = ["White"])
  ...
  text_frame(576, 6.7, 36, 36, ["2019", "-", "2020"], ["OLD SPORT 02 ATHLETIC NCV Regular" for idx in range(3)], [11,11, 11], 
             colors = ["White" for idx in range(3)], line_spacing = 7)
  insert_image(0, 36, 613, 721, "RURP_cover.jpg")
  insert_image(20, 56, 50, 50, "./Division_logos/Liga_Atlética_Interuniversitaria_logo.png")
  text_frame(0, 760, 612, 40, ["Marienid Tirado"], ["Playball Regular"], [32], colors = ["White"])