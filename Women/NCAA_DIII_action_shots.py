...
players_list = []
players_names_list = []
with open("NCAA_DIII_action.csv") as f:
  ...
  for line in f:
    ...
    if (full_name[1] == "de" or full_name[1] == "La"):
      ...
      if (player_name in players_names_list): 
        ...
        image_filename = "./NCAA_DIII_action/" + first_name + "_" + full_name[1] + "_" + full_name[2] + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./NCAA_DIII_action/" + first_name + "_" + full_name[1] + "_" + full_name[2] + ".jpg"
    else:
      player_name = first_name + " " + first_last_name
      if (player_name in players_names_list): 
        player_name_count = sum([1 for plyr in players_names_list if plyr == player_name])
        image_filename = "./NCAA_DIII_action/" + first_name + "_" + first_last_name + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./NCAA_DIII_action/" + first_name + "_" + first_last_name + ".jpg"
      
    lozada_caraballo = "Kianna Lozada & Natalia Caraballo"
    if (current_line_list[0] == lozada_caraballo):
      player_name = lozada_caraballo
      image_filename = "./NCAA_DIII_action/" + lozada_caraballo.replace(" ", "_") + ".jpg"
  ...
  for page in range(num_pages):
    ...
    for row in range(4):
      for col in range(2):
        ...
        if (current_player[0] in [lozada_caraballo]):
