...
players_list = []
players_names_list = []
with open("club_60_blocks.csv") as f:
  ...
  for line in f:
    ...
    if (full_name[1] == "de" or full_name[1] == "La"):
      ...
      if (player_name in players_names_list): 
        ...
        image_filename = "./" + "Club_60_blocks/"  + first_name + "_" + full_name[1] + "_" + full_name[2] + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_60_blocks/" + first_name + "_" + full_name[1] + "_" + full_name[2] + ".jpg"
    else:
      player_name = first_name + " " + first_last_name
      if (player_name in players_names_list): 
        player_name_count = sum([1 for plyr in players_names_list if plyr == player_name])
        image_filename = "./" + "Club_60_blocks/" + first_name + "_" + first_last_name + "_" + str(player_name_count + 1) + ".jpg"
      else:
        image_filename = "./"  + "Club_60_blocks/" + first_name + "_" + first_last_name + ".jpg"
    ...
    player_stat_1 = current_line_list[-3]
...
if newDocument(PAPER_LETTER, margins, PORTRAIT, 1,  UNIT_POINTS, NOFACINGPAGES, FIRSTPAGERIGHT, 1):
  ...
  for page in range(num_pages):
    ...
    page_title = "The blocking crew\n"
    page_subtitle = "Players with 60+ blocks"
    ...
    for row in range(2):
      for col in range(3):
        ...
        stat_banner_ellipse = createEllipse(banner_x + 122, (photo_y + stat_banner_height - ellipse_height / 2), ellipse_width, ellipse_height)
        setFillColor("White", stat_banner_ellipse); setLineColor("None", stat_banner_ellipse)
        
        stat_banner = createRect(banner_x + 122, photo_y, 44, 24)
        setFillColor("White", stat_banner); setLineColor("None", stat_banner)
        stat_text = createText(banner_x + 122, photo_y + 7, 44, 24)
