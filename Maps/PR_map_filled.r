...
p <- ggplot(pr_data_join, aes(fill = factor(ifelse(!is.na(pr_data_join$PlayerCount), 1, 2)))) + geom_sf(color = "white") + 
...
print(p)
ggsave(filename = "pr_map_filled.png", plot = p, width = 16.05, height = 7.5)